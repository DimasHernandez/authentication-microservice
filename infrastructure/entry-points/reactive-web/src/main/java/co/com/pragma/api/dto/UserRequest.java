...
public record UserRequest(
        ...
        @Pattern(regexp = "^[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$", message = "Email no valido")
        String email,
        ...
        @NotBlank(message = "El tipo_documento no puede ser vacio")
        String documentType,

        @NotBlank(message = "El numero del documento es obligatorio")
        String documentNumber,

        @NotNull(message = "La fecha de nacimiento es obligatorio")
        LocalDate birthDate,

        @NotBlank(message = "La dirección es obligatoria obligatorio")
        String address,
